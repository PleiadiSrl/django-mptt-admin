...
def get_tree_from_queryset(queryset, on_create_node=None, max_level=None, tree_label_field_name=None):
    """
    ...
    for instance in queryset:
        ...
        label = getattr(instance, tree_label_field_name, six.text_type(instance))
