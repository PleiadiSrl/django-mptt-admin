...
class DjangoMpttAdminMixin(object):
    ...
    # define which model field should be the label for tree item
    tree_label_field_name = 'None'
    ...
    def get_tree_data(self, qs, max_level):
        ...
        return util.get_tree_from_queryset(qs, handle_create_node, max_level, self.tree_label_field_name)
